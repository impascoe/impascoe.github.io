...
- Standard Python packaging and requirements management
...
2. Provide an OpenWeatherMap API key.
3. Open the notebook locally or in Colab.
4. Fetch, inspect, and visualise weather data through notebook cells.
